/**
    ...
    You can start from mandelbrot.cpp and example.h, which main functions are called from here.
*/
...
void run()
{
    ...
    */
    ...
    // See mandelbrot.cpp for the shutdown function implementation
    mandelbrotDestroy();
